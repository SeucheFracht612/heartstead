...
struct GameApplicationBenchmarkSummary {
    ...
    double mean_frontend_preparation_ms = 0.0;
    double mean_lighting_preparation_ms = 0.0;
    double mean_shadow_preparation_ms = 0.0;
    double mean_chunk_draw_preparation_ms = 0.0;
    double mean_scene_preparation_ms = 0.0;
    double mean_shadow_command_build_ms = 0.0;
    double mean_debug_ui_preparation_ms = 0.0;
    double mean_backend_execute_ms = 0.0;
    double mean_backend_frame_setup_ms = 0.0;
    ...
    double mean_queue_submit_ms = 0.0;
    double mean_gpu_wait_ms = 0.0;
    double mean_frame_context_wait_ms = 0.0;
    double mean_swapchain_acquire_ms = 0.0;
    double mean_queue_present_ms = 0.0;
    double mean_gpu_shadow_ms = 0.0;
    double mean_gpu_sky_ms = 0.0;
    ...
    double mean_gpu_tone_map_ms = 0.0;
    double mean_gpu_ui_ms = 0.0;
