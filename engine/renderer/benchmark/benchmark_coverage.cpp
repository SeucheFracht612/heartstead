...
constexpr std::array coverage{
    ...
    BenchmarkCoverageEntry{"rapid-edits", BenchmarkSceneKind::rapid_voxel_edits,
                           "single-block invalidation, boundary remeshing, response latency"},
    BenchmarkCoverageEntry{"mass-excavation", BenchmarkSceneKind::mass_excavation,
                           "edit storms, coalescing, stale work, backlog recovery"},
