...
- benchmark schema v4 with commit, dirty state, build, compiler, OS, CPU, GPU, driver, run
  configuration;
- native player benchmark schema v1 with settled-workload readiness, full-frame/mode/renderer raw
  samples, explicit validation state, and fail-closed startup/completion;
