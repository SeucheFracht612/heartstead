...
materializes the effective base before removing the covered journal. Direct concurrent mutation and
checkpoint still require external serialization, so asynchronous live compaction is not yet closed.
