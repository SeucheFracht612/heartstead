...
plus-or-minus 10 ms configured delay variation, and 2% unreliable loss. It retains raw server and
runtime time, input/reconciliation/correction work, encoded offered load, eligible-unreliable loss,
in-flight impairment, reliable backlog, and transport failures. Three clean Release processes at
commit `be4c60d` passed every gate with median server P95/P99/max of 0.018/0.019/0.682 ms. All
