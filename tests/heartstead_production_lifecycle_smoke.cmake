...
function(read_slot_timestamps slot_path created_name played_name saved_name)
  ...
  string(REGEX MATCH "last_played_at_ms\\|([0-9]+)" played_line "${metadata}")
  if(NOT played_line)
    message(FATAL_ERROR "save slot has no last-played timestamp: ${metadata}")
  endif()
  set(last_played_at "${CMAKE_MATCH_1}")
  ...
  if(created_at LESS 1500000000000 OR last_played_at LESS created_at OR
     last_saved_at LESS created_at)
    message(FATAL_ERROR
      "save timestamps are not valid Unix wall-clock milliseconds: ${created_at}, ${last_played_at}, ${last_saved_at}")
  endif()
  set(${created_name} "${created_at}" PARENT_SCOPE)
  set(${played_name} "${last_played_at}" PARENT_SCOPE)
...
read_slot_timestamps("${first_slot}" first_created first_played first_saved)
...
read_slot_timestamps("${second_slot}" second_created second_played second_saved)
...
read_slot_timestamps("${first_slot}" reloaded_created reloaded_played reloaded_saved)
...
if(reloaded_played LESS first_played)
  message(FATAL_ERROR "reloading moved the last-played wall clock backwards")
endif()
